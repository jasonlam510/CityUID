...
typedef enum CityUIDDetectSceneEvent {
    CityUIDDetectSceneDetectedEvent,
    CityUIDDetectSceneErrorEvent,
    CityUIDDetectSceneFatalErrorEvent,
} CityUIDDetectSceneEvent;
